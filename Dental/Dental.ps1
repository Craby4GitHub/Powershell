...
$Xaml = @"
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" Width="800" Height="400"><Window.Resources>
	<ResourceDictionary>
...
<Grid>
 <ComboBox HorizontalAlignment="Left" VerticalAlignment="Top" Width="120" Margin="317,52,0,0"/>
<TextBlock HorizontalAlignment="Left" VerticalAlignment="Top" TextWrapping="Wrap" Text="TextBlock" Margin="212,171,0,0"/>
<ListView HorizontalAlignment="Left" BorderBrush="Black" BorderThickness="1" Height="100" VerticalAlignment="Top" Width="100" Margin="367,179,0,0"/>
<ListBox HorizontalAlignment="Left" BorderBrush="Black" BorderThickness="1" Height="100" VerticalAlignment="Top" Width="100" Margin="534,188,0,0"/>
<DataGrid HorizontalAlignment="Left" VerticalAlignment="Top" Width="100" Height="100" Margin="37,206,0,0"/>
</Grid></Window>
"@
