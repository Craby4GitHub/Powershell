...
foreach ($computername in $list){
    ...
    if(Get-WmiObject -Class win32_networkadapter -ComputerName $computername | Where-Object {($_.Name -like "Intel(R) Ethernet Connection I217-LM") -or ($_.Name -like "Intel(R) 82579LM Gigabit Network Connection")}){
